...
ADMINS = [
	('administrateur','daniel@danielpicque.fr')
]
MANAGERS  =  ADMINS

# Pour l'envoi de mails
EMAIL_HOST = 'danielpicque.fr'
SERVER_EMAIL = 'snapnews@danielpicque.fr'
EMAIL_PORT = 587
EMAIL_HOST_USER = 'snapnews@com-uep.info'
EMAIL_HOST_PASSWORD = 'Snapnews'
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
...
WSGI_APPLICATION = 'buzzer.wsgi_ovhfm3.application'
